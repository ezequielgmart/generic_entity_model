...
* On that folder you guys will be able to find an implementation using the "author" as example. Here you'll be able to see how the db.js config file should like, also the repository file and the entity. 
